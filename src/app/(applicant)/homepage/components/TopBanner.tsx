...
export default function TopBanner() {
  ...
  return (
    <>
      {pathname === "/homepage" && (
        <div className="bg-[#1D4ED8]  lg:rounded-[40px] md:rounded-[30px] rounded-[20px] text-white flex items-center gap-8 mb-8">
          <div className="xl:py-11 lg:py-8 py-6 pl-[42px] flex-[.7]">
            ...
            <p className="lg:text-base md:text-sm text-xs font-normal">
              ...
              your skills, confidence, and career potential—helping you stand
              out from the crowd.
            </p>
          </div>
          <Image
